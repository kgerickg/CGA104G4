...
<title>福袋資料新增 - addLucky.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>福袋資料新增 - addLucky.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/front-lucky/select_page.jsp"><img src="<%=request.getContextPath()%>/front-lucky/images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
