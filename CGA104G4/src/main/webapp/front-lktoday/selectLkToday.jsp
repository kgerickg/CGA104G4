...
<ul>
  ...
  <li style="font-weight: bolder; font-size: 1.2em;">
	<a style="text-decoration: none" href='<%=request.getContextPath()%>/lucky/lucky.do?action=getAllForStore'>查詢所有福袋</a>
  </li>
  <br>
  ...
  <li style="font-weight: bolder; font-size: 1.2em">
	<a style="text-decoration: none" href='addLucky.jsp'>新增福袋</a>
  </li>
  <br>
