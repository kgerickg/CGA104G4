...
<body>
						...
						<div class="profile-section">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item"><a class="nav-link active"
									...
									aria-controls="orders" aria-selected="true">我的訂單</a></li>
							</ul>
									...
									<div class="order-tables-sec">
										...
										<div class="ord-tablez">
											...
											<c:forEach var="ordersVO"
												items="${ordersSvc.getOrdersByMemId(memId)}">
												<div class="oc-table">
													...
													<div class="oct-table-head">
														...
														<a
															...
															title="" class="tog-down"><i class="fa fa-angle-down"></i></a>
													</div>
													<!--oct-table-head end-->
	...
	<%
	if (request.getAttribute("listDetails_ByOrdId_B") != null) {
	%>
