...
<table>
	...
	<tr>
		<td>結帳金額:</td>
		<td><input type="TEXT" name="ordAmt" size="45" value="<%=ordersVO.getOrdAmt()%>"/></td>
	</tr>
	<tr>
		<td>訂單狀態:</td>
		<td><input type="TEXT" name="ordStat" size="45"	value="<%=ordersVO.getOrdStat()%>" /></td>
	</tr>
	<tr>
		<td>訂單成立日期:</td>
		<td><input type="TEXT" name="comm" id="f_date1" size="45" value="<%=ordersVO.getOrdTime()%>" /></td>
	</tr>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=ordersVO.getOrdTime()%>', // value:   new Date(),
