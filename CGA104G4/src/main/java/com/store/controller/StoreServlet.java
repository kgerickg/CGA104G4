...
//			String storeAdr = req.getParameter("storeAdr").trim();
//
//
...
//			/*************************** 2.開始修改資料 *****************************************/
//			StoreService storeSvc = new StoreService();
//			storeVO = storeSvc.updateStore(storeId, storeAcc, storePwd, storeName, storeGui, storeTel, storeAdr, storeCon, storeConTel, storeConAd, storeEmail );
//
